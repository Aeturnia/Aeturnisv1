...
export declare enum TutorialObjectiveType {
...
export declare enum TutorialRewardType {
...
export declare enum TutorialUrgency {
    LOW = "low",
    MEDIUM = "medium",
    HIGH = "high",
    CRITICAL = "critical"
...
export declare enum TutorialHelpCategory {
