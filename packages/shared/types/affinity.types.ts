...
export interface WeaponAffinity {
  ...
  lastUsed: Date;
  favoriteWeapon?: string; // specific weapon name
}
...
export enum AffinityUsageContext {
  COMBAT = 'combat',
  TRAINING = 'training',
  CRAFTING = 'crafting',
...
export enum AffinityRewardType {
