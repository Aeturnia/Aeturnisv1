...
export function ServiceTester() {
  ...
  if (!isVisible) {
    return (
      <button
        ...
        className="fixed bottom-4 left-4 z-[10002] bg-blue-600 hover:bg-blue-700 text-white px-3 py-2 rounded text-sm shadow-lg"
      >
        Test Services
      </button>
    )
  ...
  return (
    <div className="fixed bottom-16 left-4 z-[10002] bg-gray-900 text-white rounded-lg shadow-xl p-4 w-80 max-h-96 overflow-y-auto border border-gray-700">
