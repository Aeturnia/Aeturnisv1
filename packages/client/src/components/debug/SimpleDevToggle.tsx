  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-4 right-4 z-[10000] w-12 h-12 bg-purple-600 hover:bg-purple-700 text-white rounded-full shadow-lg flex items-center justify-center transition-all transform hover:scale-110"
      ...
      {/* Dev Panel */}
      {showPanel && (
        <div className="fixed bottom-20 right-4 z-[9999] bg-gray-900 text-white rounded-lg shadow-xl p-4 w-72 border border-gray-700">
